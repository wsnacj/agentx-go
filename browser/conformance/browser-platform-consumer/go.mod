...
require (
	github.com/wsnacj/agentx-go/browser v0.0.0-20260802181435-e8fd32c2cfc8
...
require github.com/wsnacj/agentx-go/runtime v0.0.0-20260802113655-f41de95ec5be // indirect
