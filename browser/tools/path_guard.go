...
func resolvePathWithinRoot(root, target string) (resolved, display string, err error) {
...
func ensurePathWithinBoundary(rootRealDir, candidateRealPath, rawTarget string) error {
