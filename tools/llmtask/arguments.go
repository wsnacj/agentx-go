...
func llmTaskOutputSchema() map[string]any {
	return map[string]any{
		...
		"properties": map[string]any{
			...
			"result":         map[string]any{"type": "object", "description": "Parsed JSON object returned by the model.", "additionalProperties": true},
			"raw_json":       stringSchema("Raw JSON result string returned by the model."),
		},
		"required": []string{"tool", "model", "schema_applied", "result", "raw_json"},
	}
}
