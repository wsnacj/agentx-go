...
| `runtime/controlcontract` | Experimental extension | [API](../../runtime/controlcontract/API.md) | 执行控制合同、Objective kernel、Host effect、adapter catalog/request/readback、Managed Objective Ingress及closeout projection |
