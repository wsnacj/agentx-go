...
技术checkpoint并获Owner接受。M6A正在补Developer Preview兼容、维护、支持、安全报告、
版本epoch与分发预检合同。
...
4. [公共执行模型](concepts/execution-model.md)
5. [Go API Reference](reference/agentx.md)
6. [生命周期与错误处理](guides/lifecycle-and-errors.md)
7. [自定义 Adapter](guides/custom-adapter.md)
8. [Host Kit + Model/Tool Adapter](guides/model-tool-hostkit.md)
9. [Workflow Host Kit](guides/workflow-hostkit.md)
10. [A 股 Portable Domain Extension](guides/astock-extension.md)
11. [Portable Skills 接入](guides/portable-skills.md)
12. [Run 与 Artifact 数据平面](guides/run-data-plane.md)
13. [ProductShell 两阶段准备](guides/product-shell-preparation.md)
14. [ProductShell Observation与Host Handoff](guides/product-shell-observation-handoff.md)
15. [Package API 索引与成熟度矩阵](reference/package-maturity.md)
16. [成熟度与兼容边界](maturity.md)
17. [HS 迁移说明](guides/hs-migration.md)
