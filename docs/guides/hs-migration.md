...
adapter、policy或 backend的完整 embedded Runtime；Workflow composition也还未
成为根 `Client` 的稳定 Facade入口。Scene、Objective、Resume、durable backend、
正式发行和 Public/Beta/Stable均不在 M3D范围。
